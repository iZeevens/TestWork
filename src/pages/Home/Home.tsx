  ...
  const dialogs = [
    {
      ...
      text: (
        <>
          Сейчас мы узнаем, как защитить свои данные на платформе объявлений.
          Это <b>важно знать</b>, чтобы никто не смог обмануть или украсть твои
      ...
      <main className={styles.content}>
        ...
        {dialogs.map((dialog) => (
          <DialogUI
            ...
            btnPostion={
              dialog.buttonPosition as "left" | "right" | undefined
            }
            type={dialog.type as "left" | "bottom" | undefined}
